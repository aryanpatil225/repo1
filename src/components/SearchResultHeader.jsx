...
const SearchResultHeader = () => {
  ...
  return (
    <div className="p-[15px] pb-0 md:pr-5 md:pt-7 border-b border-[#ebebeb] flex md:block flex-col items-center sticky top-0 bg-white">
        ...
        {menu.map((menu, index) => (
          <span
            ...
            className={`flex items-center p-3 text-[#5f6368] cursor-pointer relative ${
              //relative because when we use 100%-20px so it take straight line, so to avoid we use relative
